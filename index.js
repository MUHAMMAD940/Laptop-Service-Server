...
client.connect(err => {
    ...
    // services Database
    const services = client.db("laptopServices").collection("services");
    ...
    const purchased = client.db("laptopServices").collection("purchasedService");
    ...
    // Admin Database
    const adminCollection = client.db("laptopServices").collection("admin");
    ...
    // reviews Database
    const reviews = client.db("laptopServices").collection("reviews");
